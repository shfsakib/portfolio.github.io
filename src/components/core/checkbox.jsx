...
export const CheckBox = ({ options, label, name, sup, formik }) => {
        ...
        <div className="col-12">
            ...
            {options && options.map((value) => (
                <div key={value} className="icheck-primary d-inline">
                    <label>
                        <input type="checkbox" name={name} value={value} onChange={(e) => handleGetValue(e)} checked={formik.getFieldProps(name).value === value} />
